					...
					<section class="panel">
						...
						<div class="panel-body" style="padding-right:100px">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<textarea id="descricao" name="descricao-produto" rows="5" class="form-control" required oninvalid="this.setCustomValidity('O campo descricao é obrigatorio!')" oninput="setCustomValidity('')"/></textarea>
								</div>
							</div>										
						</div>
						<footer class="panel-footer">
							<div class="row" style="padding-left:100px">
								<div class="col-sm-9 col-sm-offset-3">
									<button type="submit" name="operacao" value="SALVAR-PRODUTO" class="btn btn-primary">Cadastrar produto</button>
