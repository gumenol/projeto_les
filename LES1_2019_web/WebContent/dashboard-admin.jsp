			...
			<div id="responsive-nav">
				...
				<div class="menu-nav">
					...
					<ul class="menu-list">
							...
							<li class="dropdown default-dropdown"><a id="produtos" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true">Produtos <i class="fa fa-caret-down"></i></a>
								<ul class="custom-menu">
									<li><a id="visualizar" href="Produtos?operacao=CONSULTAR">Visualizar produtos</a></li>
