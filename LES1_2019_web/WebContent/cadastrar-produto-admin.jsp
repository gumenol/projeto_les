			...
			<div style="text-align: center">
				<form id="form-cadastro" action="Produtos" method="POST" class="form-horizontal">
					<section class="panel">
						...
						<div class="col-sm-1">
								<a id="listagem" href="Produtos?operacao=CONSULTAR" style="background-color:grey; color:white" class="btn btn-default">Voltar para a listagem</a>
							</div>
						...
						<div class="panel-body" style="padding-right:100px">
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input id="nome" type="text" name="nome-produto" class="col-sm-3 form-control" required oninvalid="this.setCustomValidity('O campo nome é obrigatório!')" oninput="setCustomValidity('')"/>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" id="valor" name="valor-produto" placeholder="Apenas numeros..." class="col-sm-3 form-control" required oninvalid="this.setCustomValidity('O campo valor é obrigatorio!')" oninput="setCustomValidity('')"/>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<textarea id="descricao" name="descricao-produto" rows="5" 
									class="form-control" required oninvalid="this.setCustomValidity('O campo descricao é obrigatorio!')" 
						...
						<footer class="panel-footer">
							<div class="row" style="padding-left:100px">
								<div class="col-sm-9 col-sm-offset-3">
									<button type="submit" name="operacao" value="SALVAR" class="btn btn-primary">Cadastrar produto</button>
